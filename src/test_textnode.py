...
class TestTextNode(unittest.TestCase):
    ...
    def test_image(self):
        node = TextNode("This is an image node", TextType.IMAGE, "www.bing.com")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "img")
        self.assertEqual(html_node.value, "")
        self.assertEqual(html_node.props, {"src": "www.bing.com", "alt": "This is an image node"})

    def test_wrong_value(self):
        BOLD = ""
        node = TextNode("This is an image node", BOLD, "www.bing.com")
